                    ...
                    {canManageAcl && (
                        <Form method="post" className="flex flex-wrap gap-4 items-end border-b pb-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select onValueChange={(value) => setConditionType(value)} name="conditionType" defaultValue="perm">
                                    <SelectTrigger className="w-52">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="perm">Permission</SelectItem>
                            ...
                            <div className="space-y-2">
                                ...
                                {conditionType === 'perm' ? (
                                    <Select name="condition" defaultValue="any">
                                        ...
                                        <SelectContent>
                                            <SelectItem value="any">아무나</SelectItem>
                                            <SelectItem value="member">회원</SelectItem>
                                            <SelectItem value="ip">IP 사용자</SelectItem>
                                            <SelectItem value="match_username_and_document_title">사용자 이름과 문서 이름이 일치</SelectItem>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select name="allow" defaultValue="true">
                                    <SelectTrigger className="w-52">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
